const renderFinancesList = (data) => {
  ...
  data.map((item) => {
    ...
    const tittleTd = document.createElement("td");
    const tittleText = document.createTextNode(item.tittle);
    tittleTd.appendChild(tittleText);

    tableRow.appendChild(tittleTd);
